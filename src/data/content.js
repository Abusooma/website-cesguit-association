...
export const MANDATS = [
  ...
  },
  {
    ...
    membres: [
      ...
      { nom: 'Binta Baldé', role: 'Trésorière', photo: '/img/bureau/2025/tresoriere.jpeg' },
      { nom: 'Fanta Kaba', role: 'Trésorière', photo: '/img/bureau/2025/tresoriere2.jpeg' },
      ...
      { nom: 'Mohamed Lamine Camara', role: 'Président Commission Scientifique', photo: '/img/bureau/2025/comsci-pres.jpeg' },
      { nom: 'Conté', role: 'Membre de la Commission Scientifique', photo: '/img/bureau/2025/comsci-membre.jpeg' },
    ],
  },
]
...
export const EVENEMENTS_MAJ = [
  ...
  },
  {
    ...
    date: '08 mars 2025',
    cat: 'Conférence',
    img: '/img/ev-journee-femme.jpg',
    desc: "Un panel pour honorer la femme et mettre en valeur tout ce qu'elle symbolise dans la société.",
    lien: '',
  },
  {
    titre: 'Fête de Tabaski',
    date: '2026',
    cat: 'Culturel',
    img: '/img/ev-tabaski.jpg',
    desc: "La Tabaski loin du pays, dans l'ambiance « Tabaski Vibes » : partage, musique et retrouvailles de toute la communauté.",
    lien: '',
  },
  {
  ...
  },
  {
    ...
    date: 'Ramadan 2025',
    cat: 'Solidarité',
    img: '/img/ev-rupture-collective.jpg',
...
export const ARTICLES = [
  {
    ...
    titre: 'Carte de séjour : le guide complet 2025/2026',
    resume:
      'Première demande, renouvellement, perte ou dommage : la liste officielle des documents à préparer, à jour pour 2025/2026.',
    ...
    contenu: [
      ...
      { type: 'p', text: "Le dossier se dépose au poste de police de votre lieu de résidence. Selon votre situation, les pièces demandées changent : voici les trois cas, à jour pour 2025/2026." },

      { type: 'h', text: '1. Première demande (nouveaux étudiants)' },
      { type: 'list', items: [
        'Copie simple de la première page du passeport valide (×3)',
        "Copie simple du dernier cachet d'entrée en Tunisie, ou du visa (×3)",
        "Photos d'identité (×4)",
        "Copie conforme de l'attestation de logement ou du contrat de maison (×3)",
        "Copie conforme de l'attestation d'inscription (×3)",
        "Copie conforme de l'attestation de paiement (×3)",
        "Copie conforme de l'attestation de présence (×3)",
        'Justificatif de bourse ou preuve de ressources financières — original (×1)',
        'Une quittance de 75 dinars (×1)',
        'Timbre fiscal de 10 dinars (×1)',
      ] },

      { type: 'h', text: '2. Renouvellement de la carte de séjour' },
      { type: 'list', items: [
        'Copie simple de la première page du passeport valide (×3)',
        "L'originale de la carte de séjour précédente (×1)",
        "Photos d'identité (×4)",
        "Copie conforme de l'attestation de logement ou du contrat de maison (×3)",
        "Copie conforme de l'attestation d'inscription (×3)",
        "Copie conforme de l'attestation de paiement (×3)",
      ...
      { type: 'h', text: '3. En cas de perte ou de dommage' },
      { type: 'list', items: [
        'Copie de la première page du passeport valide (×3)',
        "Copie conforme de la page du passeport contenant le dernier cachet d'entrée (×3)",
        "Photos d'identité (×4)",
        "Copie conforme de l'attestation de logement ou du contrat de maison (×3)",
        "Copie conforme de l'attestation d'inscription (×3)",
        "Copie conforme de l'attestation de paiement (×3)",
        "Copie conforme de l'attestation de présence (×3)",
        'Justificatif de bourse ou preuve de ressources financières — original (×1)',
        'Une quittance de 300 dinars (×1)',
        'Timbre fiscal de 10 dinars (×1)',
        'Certificat de perte — original, à obtenir au poste de police (×1)',
      ] },

      { type: 'h', text: 'Le justificatif de ressources (pièce 8) : au choix' },
      { type: 'list', items: [
        'Les originaux des reçus bancaires ;',
        "ou les originaux des reçus des cartes de retrait, avec la copie de la carte bancaire au nom de l'étudiant ;",
        'ou un relevé bancaire, ou les originaux Western Union / MoneyGram / RIA.',
      ] },

      { type: 'h', text: 'Bon à savoir' },
      { type: 'list', items: [
        'La quittance et le timbre fiscal se paient / s\'achètent à la recette des finances, en présentant le passeport.',
        'Les « copies conformes » se font certifier à la municipalité (baladiya).',
        'Gardez une copie de tout le dossier et notez le récépissé de dépôt.',
      ] },

      { type: 'p', text: "Pour les boursiers de l'intérieur, la Cellule d'Action Boursière (C.A.B) de la CESGUIT vous accompagne et fait le lien avec les autorités. En cas de blocage, contactez-nous : personne ne reste seul devant un guichet." },
    ],
  },
  {
    slug: 'bourse-snabe',
